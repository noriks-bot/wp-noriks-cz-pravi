	...
	acf_add_local_field_group( array(
		...
		'fields' => array(
			array(
				...
				'label'        => 'Zobrazit upsell pod tlačítkem (3x Modré boxerky)',
				'name'         => 'noriks_pp_upsell',
				'type'         => 'true_false',
				'instructions' => 'Přidá rámeček "Kupte společně a ušetřete" hned pod tlačítko Přidat do košíku. Zákazník vybere velikost a 3 kusy se přidají za upsell cenu. Platí jen pro tento produkt.',
				'ui'           => 1,
			),
		),
		'location'   => array(
...
function noriks_pp_upsell_config() {
	return apply_filters( 'noriks_pp_upsell_config', array(
		...
		'total'      => 357,                   // ista cijena kao thank you upsell (3 x 4,99)
