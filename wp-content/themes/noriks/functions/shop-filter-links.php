...
function noriks_shop_filter_map() {
	return apply_filters( 'noriks_shop_filter_map', array(
		'__shop__' => array(
			...
			'startovaci-balicek' => 'Startovací balíček',
			'velke-baliky' => 'Velké balíky',
		),
		'boxerky' => array(
			'1-ks-boxerky' => '1 ks',
			'balicek-3-ks-boxerky' => 'Balíček 3 ks',
			'balicek-5-ks' => 'Balíček 5 ks',
			'balicek-7-ks' => 'Balíček 7 ks',
			'balicek-10-ks' => 'Balíček 10 ks',
		...
		'sady' => array(
			'sada-2-tricka-5-boxerek' => 'Sada: 2 trička + 5 boxerek',
			'sada-4-tricka-10-boxerek' => 'Sada: 4 trička + 10 boxerek',
			'sada-5-tricek-5-boxerek' => 'Sada: 5 triček + 5 boxerek',
		),
		'tricka' => array(
			'1-ks' => '1 ks',
