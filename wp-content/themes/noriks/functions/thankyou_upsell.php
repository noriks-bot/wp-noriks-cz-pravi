...
function noriks_handle_add_upsell() {
    ...
    $order = wc_get_order( $order_id );
    if ( ! $order ) wp_send_json_error( 'Objednávka nebyla nalezena' );
    ...
    if ( ! $product ) wp_send_json_error( 'Produkt nebyl nalezen' );
    ...
    $bokserice_prices = array( 1 => 199, 3 => 499, 5 => 749 );
    ...
    if ( ! $item_id ) wp_send_json_error( 'Chyba pri dodavanju' );
