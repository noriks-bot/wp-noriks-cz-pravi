...
const NORIKS_FLASH_CAT   = 'letni-vyprodej';
...
function noriks_flash_deals_banner() {
    ...
    ?>
    <div class="nfd" role="region" aria-label="Letní výprodej">
      <div class="nfd-in">
        <div class="nfd-left">
          <p class="nfd-eyebrow">Sezónní slevy</p>
          <div class="nfd-head">
            <h2 class="nfd-title">Letní výprodej</h2>
            <?php if ( $off > 0 ) : ?>
              <span class="nfd-badge">-&minus;<?php echo (int) $off; ?>%</span>
            <?php endif; ?>
          </div>
          <p class="nfd-sub">Zlevněno, dokud zásoby stačí</p>
        </div>

        <div class="nfd-right">
          <span class="nfd-cta">Nabídka končí za</span>
