 ...
 *
 * Stranica se kreira jednom iz teme (slug: navody) i koristi predlozak page-upute.php.
...
function noriks_manuals_list() {
    return array(
        array(
            ...
            'title' => 'Trička NORIKS',
            'sub'   => 'Bavlněná trička — výběr velikosti, nošení a péče.',
        ),
        array(
            'file'  => 'noriks-bokserice.pdf',
            'sku'   => 'NORIKS-BOX-BLACK-5-PACK',
            'title' => 'Boxerky NORIKS',
            'sub'   => 'Modalové boxerky — rozměry, nošení a péče.',
        ),
        array(
            'file'  => 'noriks-kompresijske-carape.pdf',
            'sku'   => array( 'NORIKS-KOMZIPS', 'NORIKS-BOXERS-ORTO-4' ),
            'title' => 'Kompresní punčochy NORIKS se zipem',
            'sub'   => 'Odstupňovaná komprese 15–20 mmHg s bočním zipem.',
        ),
        array(
            'file'  => 'noriks-kneefix.pdf',
            'sku'   => 'NORIKS-KNEEFIX',
            'title' => 'NORIKS KneeFix — ortopedická kolenní ortéza',
            'sub'   => 'Nastavitelná komprese, boční stabilizátory a gelová vložka na čéšku.',
        ),
        array(
            'file'  => 'noriks-bunion-fix.pdf',
            'sku'   => 'NORIKS-BUNION',
            'title' => 'NORIKS Bunion Fix — korektor vbočeného palce',
            'sub'   => 'Postupné narovnávání palce při 30 minutách až 3 hodinách denně.',
        ),
        array(
            'file'  => 'noriks-ortopas.pdf',
            'sku'   => 'NORIKS-ORTOPAS',
            'title' => 'NORIKS ortopedický pás na záda',
            'sub'   => 'Cílená komprese pro bederní oblast a stabilizace při každodenních pohybech.',
        ),
        array(
            'file'  => 'noriks-fisiorest.pdf',
            'sku'   => 'NORIKS-FISIOREST',
            'title' => 'NORIKS FisioRest — přístroj na krk',
            'sub'   => 'Trakce, teplo a vibrační masáž v sezení od 15 do 30 minut.',
        ),
        array(
            'file'  => 'noriks-fit-kompresijska-majica.pdf',
            'sku'   => 'NORIKS-KOMPSFIT',
            'title' => 'NORIKS FIT — kompresní tričko',
            'sub'   => 'Přiléhavá komprese, která vyhlazuje siluetu a podporuje vzpřímené držení těla.',
        ),
        array(
            'file'  => 'noriks-leakbox.pdf',
            'sku'   => 'NORIKS-LEAKBOX',
            'title' => 'NORIKS PureDry — pratelné boxerky při inkontinenci',
            'sub'   => 'Až 300 ml savosti, sedmivrstvé jádro a voděodolná membrána.',
        ),
        array(
            'file'  => 'noriks-ergosit.pdf',
            'sku'   => 'NORIKS-ERGOSIT',
            'title' => 'NORIKS ErgoSit — ortopedický sedací polštář',
            'sub'   => 'Výřez pro kostrč a paměťová pěna o vysoké hustotě pro dlouhé sezení.',
        ),
        array(
            'file'  => 'noriks-kidsnest.pdf',
            'sku'   => 'NORIKS-KIDSNEST',
            'title' => 'NORIKS KidsNest — dětský ortopedický polštář',
            'sub'   => 'Tři velikosti, které rostou s dítětem a podporují správnou polohu hlavy.',
        ),
    );
}
...
function noriks_manuals_ensure_page() {
    ...
    $existing = get_page_by_path( 'navody' );
    if ( $existing ) {
