...
<div id="custom-size-chart-modal" aria-modal="true" role="dialog" aria-labelledby="custom-size-chart-title">
  <div class="size-chart-titlebar">
    <h2 id="custom-size-chart-title">Tabulka velikostí</h2>
  ...
  <div  style="<?php if ( has_term( array( 'orto-starter', 'orto-majica-bokserica' ), 'product_cat', get_the_ID() ) ): ?>  display: block; <?php endif; ?>"
      ...
      <div class="noriks-bx">
        ...
        <div class="noriks-bx-wrap">
          <table class="noriks-bx-t">
            <thead>
              <tr><th>Velikost</th><th>S</th><th>M</th><th>L</th><th>XL</th><th>2XL</th><th>3XL</th><th>4XL</th></tr>
            </thead>
            <tbody>
        ...
        <img class="noriks-bx-fig" src="<?php echo esc_url( get_template_directory_uri() . '/img/boxers-measure.webp' ); ?>"
             alt="Rozměry boxerek: a, b, c, d" loading="lazy">
        <p class="noriks-bx-note"><strong>Vyberte stejné číslo, jaké běžně nosíte.</strong><br>Rozměry jsou v centimetrech. Velikosti se mohou lišit o &plusmn;1&ndash;2 cm. Pokud jste mezi dvěma velikostmi, zvolte menší &mdash; materiál je pružný.</p>
      </div>
    ...
    style="margin-top: 70px;margin-bottom: 70px;"
      ...
      src="https://noriks.com/cz/wp-content/uploads/2026/01/Nogavice_tabela_velikosti_Cz.png"
      alt="Size Guide">
    ...
    style="margin-top: 35px;margin-bottom: 0px;"
      ...
      src="https://noriks.com/cz/wp-content/uploads/2026/04/cz_majice.jpeg"
      alt="Size Guide">
      ...
      <div style="margin:30px 0;padding:0 6px;">
        <p style="margin:0 0 4px;font-weight:700;font-size:15px;">Jak změřit boky</p>
        <p style="margin:0 0 14px;line-height:1.6;font-size:14px;color:#333;">Obtočte krejčovský metr kolem nejširší části boků (přes hýždě), bez utahování, a zapište si míru v centimetrech.</p>
        <table style="width:100%;border-collapse:collapse;font-size:14px;">
          <thead><tr style="background:#12233b;color:#fff;">
            <th style="padding:9px 10px;text-align:left;background:#e9e9e9 !important;color:#111 !important;">Velikost</th><th style="padding:9px 10px;text-align:left;background:#e9e9e9 !important;color:#111 !important;">Boky (cm)</th>
          </tr></thead>
          <tbody>
          <?php foreach ( array(array('S','do 76 cm','do 30"'),array('M','77 – 85 cm','30 – 33"'),array('L','86 – 94 cm','34 – 37"'),array('XL','95 – 102 cm','37 – 40"'),array('2XL','103 – 114 cm','41 – 45"'),array('3XL','115 – 121 cm','45 – 48"'),array('4XL','122 – 129 cm','48 – 51"'),array('5XL','130 – 137 cm','51 – 54"'),array('6XL','138 – 145 cm','54 – 57"'),array('7XL','146 – 153 cm','57 – 60"'),array('8XL','154 cm a více','61" a více') ) as $i=>$r): ?>
        ...
        <p style="margin-top:12px;font-size:14px;color:#444;"><strong>Mezi dvěma velikostmi?</strong> Doporučujeme větší velikost pro optimální pohodlí a maximální savost.</p>
      </div>
      ...
      <div style="margin:30px 0;padding:0 6px;">
        <table style="width:100%;border-collapse:collapse;font-size:16px;">
          <thead><tr style="background:#111;color:#fff;">
            <th style="padding:11px 12px;text-align:left;background:#e9e9e9 !important;color:#111 !important;">Velikost</th><th style="padding:11px 12px;text-align:left;background:#e9e9e9 !important;color:#111 !important;">Odpovídající hmotnost</th>
          </tr></thead>
          <tbody>
        ...
        <p style="margin-top:12px;font-size:14px;color:#444;">Zvolte velikost podle své hmotnosti. Mezi dvěma velikostmi? Pro silnější kompresi zvolte menší velikost.</p>
      </div>
      ...
      <div class="noriks-size-chart-wrap">
        ...
        <div class="noriks-sc-steps">
          <h3>Jak najít svou velikost</h3>
          <div class="noriks-sc-steps-grid">
            <div class="noriks-sc-step">
              <span class="noriks-sc-num">1</span>
              <span>Najdi svou <strong>výšku</strong> v levém sloupci.</span>
            </div>
            <div class="noriks-sc-step">
              <span class="noriks-sc-num">2</span>
              <span>Najdi svou <strong>hmotnost</strong> v horním řádku.</span>
            </div>
            <div class="noriks-sc-step">
              <span class="noriks-sc-num">3</span>
              <span>Pole, kde se protínají &mdash; to je tvoje velikost.</span>
            </div>
          </div>
        </div>
        ...
        <div class="noriks-sc-pro">
          ...
          <span>Pokud jsi mezi dvěma velikostmi a chceš <strong>volnější střih</strong>, vezmi větší. Pro <strong>přiléhavější vzhled</strong> vezmi menší.</span>
        </div>

        <div class="noriks-sc-guarantee">
          <span class="noriks-sc-check">&#10003;</span>
          <span>Nejsi si jistý? Bezplatná výměna velikosti do 90 dní.</span>
        </div>
      </div>
