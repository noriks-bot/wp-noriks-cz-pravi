...
<section class="nrd-intro">
  <div class="nrd-wrap">
    <div class="nrd-intro__top">
      <div class="nrd-intro__img"><?php echo $rd_img( 'red-meet.jpg', 'Zápěstní pás NORIKS RedRelief s červeným světlem' ); ?></div>
      <div class="nrd-intro__text">
        <p class="nrd-kicker">Poznejte NORIKS RedRelief</p>
        <h2 class="nrd-h2">Pomoc, která míří na příčinu, ne jen na příznak.</h2>
        <p>NORIKS RedRelief přivádí červené a infračervené světlo dvojí vlnové délky přesně do oblasti středního nervu — tam, kde vzniká zánět stojící za bolestí zápěstí.</p>
        <p>Tatáž terapie červeným světlem byla zkoumána z hlediska podpory tvorby buněčné energie (ATP), obnovy průtoku krve a přísunu kyslíku do tkáně — aby tělo mohlo dělat svou práci.</p>
      </div>
    </div>

    <div class="nrd-stats">
      <div class="nrd-stat"><div class="nrd-stat__big">87%</div><div class="nrd-stat__lab">Méně mravenčení a brnění</div><div class="nrd-stat__sub">Do prvních 30 dnů*</div></div>
      <div class="nrd-stat"><div class="nrd-stat__big">92%</div><div class="nrd-stat__lab">Lepší spánek celou noc</div><div class="nrd-stat__sub">Po 4+ týdnech každodenního používání*</div></div>
      <div class="nrd-stat"><div class="nrd-stat__big">94%</div><div class="nrd-stat__lab">Doporučilo by NORIKS RedRelief</div><div class="nrd-stat__sub">Přátelům a rodině*</div></div>
      <div class="nrd-stat"><div class="nrd-stat__big">71%</div><div class="nrd-stat__lab">Odložilo nebo se vyhnulo zákroku</div><div class="nrd-stat__sub">Kvůli syndromu karpálního tunelu*</div></div>
    </div>
    <p class="nrd-foot">*Podle zkušeností zákazníků, kteří NORIKS RedRelief používají pravidelně. Výsledky se liší člověk od člověka.</p>
  </div>
</section>
...
<section class="nrd-steps">
  <div class="nrd-wrap">
    <p class="nrd-kicker nrd-center">Jednodušší to už nejde</p>
    <h2 class="nrd-h2 nrd-center">Tři kroky k sezení</h2>
    <p class="nrd-sub">Bez objednávání a bez nastavování. Jen nasadíte, stisknete a uvolníte se.</p>
    <div class="nrd-steps__grid">
      <div class="nrd-steps__step">
        <div class="nrd-steps__media"><span class="nrd-steps__num">1</span><?php echo $rd_vid( 'red-vid-1.mp4', 'red-vid-1.jpg', 'Nasazení pásu na zápěstí' ); ?></div>
        <h4>Nasaďte pás</h4>
        <p>Provlékněte palec otvorem a připevněte pásek přes hřbet ruky.</p>
      </div>
      <div class="nrd-steps__step">
        <div class="nrd-steps__media"><span class="nrd-steps__num">2</span><?php echo $rd_vid( 'red-vid-2.mp4', 'red-vid-2.jpg', 'Spuštění sezení jedním tlačítkem' ); ?></div>
        <h4>Stiskněte tlačítko</h4>
        <p>Jedno stisknutí spustí 15minutové sezení. Vyberte úroveň výkonu a režim.</p>
      </div>
      <div class="nrd-steps__step">
        <div class="nrd-steps__media"><span class="nrd-steps__num">3</span><?php echo $rd_vid( 'red-vid-3.mp4', 'red-vid-3.jpg', 'Uvolnění během terapie' ); ?></div>
        <h4>Uvolněte se</h4>
        <p>Nechte světlo pracovat. Jednou denně — výsledek přináší pravidelnost.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="nrd-why">
  ...
  <div class="nrd-why__row nrd-why__row--reverse">
    <div class="nrd-why__imgwrap"><?php echo $rd_img( 'red-valne.jpg', 'Vnitřek pásu se svítícími červenými LED diodami', 'nrd-why__img' ); ?></div>
    <div class="nrd-why__content">
      <h2 class="nrd-h2">Dvě vlnové délky. Dvojí dosah.</h2>
      <p class="nrd-why__body">NORIKS RedRelief spojuje dvě nejvíce zkoumané vlnové délky v terapii červeným světlem, takže jedno sezení pokryje povrch i hloubku.</p>
      <ul class="nrd-checks">
        <li><span class="nrd-ck"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.5l4.5 4.5L19 7.5"/></svg></span><span><strong>Červené světlo 660 nm</strong> — zklidňuje povrchový zánět</span></li>
        <li><span class="nrd-ck"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.5l4.5 4.5L19 7.5"/></svg></span><span><strong>Infračervené 850 nm</strong> — dosáhne středního nervu</span></li>
      </ul>
    </div>
  </div>

  <div class="nrd-why__row">
    <div class="nrd-why__imgwrap"><?php echo $rd_img( 'red-led.jpg', '48 dvojitých LED diod v pásu', 'nrd-why__img' ); ?></div>
    <div class="nrd-why__content">
      <h2 class="nrd-h2">48 dvojitých LED diod.</h2>
      <p class="nrd-why__body">Diody jsou rozmístěné po celé vnitřní straně lehkého pásu, který kopíruje tvar zápěstí — takže každé sezení pokryje celou oblast, ne jen jeden bod.</p>
      <ul class="nrd-checks">
        <li><span class="nrd-ck"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.5l4.5 4.5L19 7.5"/></svg></span><span><strong>48 LED diod</strong> (červené + infračervené)</span></li>
        <li><span class="nrd-ck"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.5l4.5 4.5L19 7.5"/></svg></span><span><strong>3 úrovně výkonu</strong> · 4 režimy</span></li>
        <li><span class="nrd-ck"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.5l4.5 4.5L19 7.5"/></svg></span><span><strong>Pouhých 126 g</strong> — dost lehký na každý den</span></li>
      </ul>
    </div>
  </div>
...
<section class="nrd-pain">
  <div class="nrd-wrap nrd-pain__wrap">
    <div class="nrd-pain__text">
      <p class="nrd-kicker">Pro koho je NORIKS RedRelief</p>
      <h2 class="nrd-h2">Pro ruce, které pracují celý den.</h2>
      <p class="nrd-pain__body">Bolest zápěstí přichází málokdy sama. NORIKS RedRelief je určen těm, kdo každý den zatěžují ruku a zápěstí — u klávesnice, za volantem, v kadeřnictví, na stavbě nebo na zahradě.</p>
      <ul class="nrd-pills">
        <li>Syndrom karpálního tunelu</li><li>Zánět šlach</li><li>Artritida</li><li>Bolesti ruky a zápěstí</li>
      </ul>
      <p class="nrd-pain__note">Přístroj nenahrazuje lékařské vyšetření ani předepsanou léčbu.</p>
    </div>
    <div class="nrd-pain__img"><?php echo $rd_img( 'red-bolovi.jpg', 'Terapie červeným světlem na zápěstí' ); ?></div>
  </div>
</section>
...
<section class="nrd-tl">
  <div class="nrd-wrap">
  <h2 class="nrd-h2 nrd-center">Co můžete očekávat</h2>
  <p class="nrd-sub">Výsledky potřebují čas. Touto cestou jde většina uživatelů.</p>
  ...
  <div class="nrd-tl__wrap">
    ...
    <div class="nrd-tl__step nrd-tl__step--right">
      ...
      <div class="nrd-tl__content">
        <div class="nrd-tl__eyebrow">1. týden</div>
        <h3 class="nrd-tl__name">První známky úlevy</h3>
        <ul><li>Zánět kolem středního nervu začíná ustupovat</li><li>Zápěstí působí lehčeji a odlehčeně</li><li>Méně ranní ztuhlosti</li><li>Snadnější uchopení hrnku nebo volantu</li></ul>
      </div>
    </div>
    ...
    <div class="nrd-tl__step nrd-tl__step--left">
      <div class="nrd-tl__node"><svg viewBox="0 0 24 24" fill="none"><path d="M5 12.5l4.5 4.5L19 7.5" stroke="#fff" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg></div>
      <div class="nrd-tl__content">
        <div class="nrd-tl__eyebrow">2. – 3. týden</div>
        <h3 class="nrd-tl__name">Denní bolest ustupuje</h3>
        <ul><li>Mravenčení a brnění se citelně zmírňují</li><li>Síla stisku se zlepšuje</li><li>Psaní a otevírání sklenic jdou snáz</li><li>Méně sahání po tabletkách proti bolesti</li></ul>
      </div>
    </div>
    ...
    <div class="nrd-tl__step nrd-tl__step--right">
      <div class="nrd-tl__node"><svg viewBox="0 0 24 24" fill="none"><path d="M5 12.5l4.5 4.5L19 7.5" stroke="#fff" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg></div>
      <div class="nrd-tl__content">
        <div class="nrd-tl__eyebrow">4. – 6. týden</div>
        <h3 class="nrd-tl__name">Spánek celou noc</h3>
        <ul><li>Zbrnělé ruce vás už nebudí</li><li>Probuzení bez ztuhlých prstů</li><li>Návrat ke koníčkům — kytara, pletení, zahrada</li><li>Vrací se důvěra ve vlastní ruce</li></ul>
      </div>
    </div>
    ...
    <div class="nrd-tl__step nrd-tl__step--left">
      <div class="nrd-tl__node"><svg viewBox="0 0 24 24" fill="none"><path d="M5 12.5l4.5 4.5L19 7.5" stroke="#fff" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg></div>
      <div class="nrd-tl__content">
        <div class="nrd-tl__eyebrow">8.+ týden</div>
        <h3 class="nrd-tl__name">Dlouhodobé zdraví ruky</h3>
        <ul><li>Funkce zápěstí se dál zlepšuje</li><li>Bolest se stává vzpomínkou, ne každodenností</li><li>Terapie bez tablet a bez zákroku</li><li>15minutové sezení zůstává součástí dne</li></ul>
      </div>
    </div>
  </div>
  </div>
...
<section class="nrd-vs">
  <div class="nrd-wrap nrd-vs__inner">
    ...
    <h2 class="nrd-vs__title-mobile">Proč NORIKS RedRelief<sup>&reg;</sup>?</h2>
    ...
    <div class="nrd-vs__cards">
      ...
      <div class="nrd-vs__card nrd-vs__card--us">
        ...
        <div class="nrd-vs__list">
          <div class="nrd-vs__row"><span class="nrd-vs__ic nrd-vs__ic--yes">&#10003;</span>Dvojí vlnová délka</div>
          <div class="nrd-vs__row"><span class="nrd-vs__ic nrd-vs__ic--yes">&#10003;</span>48 dvojitých LED diod</div>
          <div class="nrd-vs__row"><span class="nrd-vs__ic nrd-vs__ic--yes">&#10003;</span>3 úrovně výkonu, 4 režimy</div>
          <div class="nrd-vs__row"><span class="nrd-vs__ic nrd-vs__ic--yes">&#10003;</span>Bezdrátový a nabíjecí</div>
          <div class="nrd-vs__row"><span class="nrd-vs__ic nrd-vs__ic--yes">&#10003;</span>Tvarovaný na ruku</div>
        </div>
      </div>

      <div class="nrd-vs__card nrd-vs__card--them">
        <div class="nrd-vs__card-title nrd-vs__card-title--dark">Jiné přístroje</div>
        <div class="nrd-vs__list">
          <div class="nrd-vs__row nrd-vs__row--dark"><span class="nrd-vs__ic nrd-vs__ic--no">&#10007;</span>Jen jedna vlnová délka</div>
          <div class="nrd-vs__row nrd-vs__row--dark"><span class="nrd-vs__ic nrd-vs__ic--no">&#10007;</span>Méně diod a pokrytí</div>
          <div class="nrd-vs__row nrd-vs__row--dark"><span class="nrd-vs__ic nrd-vs__ic--no">&#10007;</span>Pevná intenzita</div>
          <div class="nrd-vs__row nrd-vs__row--dark"><span class="nrd-vs__ic nrd-vs__ic--no">&#10007;</span>Závislé na zásuvce</div>
          <div class="nrd-vs__row nrd-vs__row--dark"><span class="nrd-vs__ic nrd-vs__ic--no">&#10007;</span>Univerzální střih</div>
        </div>
      </div>
    ...
    <div class="nrd-vs__copy">
      <h2 class="nrd-vs__title">Proč NORIKS RedRelief<sup>&reg;</sup>?</h2>
      <div class="nrd-vs__bullets">
        <div class="nrd-vs__bullet"><span class="nrd-vs__bc">&#10003;</span><span>Tvarovaný přímo na ruku a zápěstí</span></div>
        <div class="nrd-vs__bullet"><span class="nrd-vs__bc">&#10003;</span><span>Dvojí vlnová délka v jednom sezení</span></div>
        <div class="nrd-vs__bullet"><span class="nrd-vs__bc">&#10003;</span><span>Bezdrátově, kdekoli, 15 minut denně</span></div>
        <div class="nrd-vs__bullet"><span class="nrd-vs__bc">&#10003;</span><span>Až 4 ošetření na jedno nabití</span></div>
      </div>
      <a class="nrd-vs__cta" href="#bundle-selector">Vyzkoušejte bez rizika</a>
      <div class="nrd-vs__guar"><span class="nrd-vs__shield">&#128737;</span> 30 dní na vrácení peněz</div>
    </div>
