...
<section class="why-section knc-demo">
  <div class="knc-demo-wrap">
    <h2 class="knc-demo-title">Jak to funguje v praxi</h2>
      ...
      <table class="knc-table">
        <thead>
          <tr>
            ...
            <th class="knc-comp">Klasické punčochy<span>(Bauerfeind, medi…)</span></th>
            <th class="knc-comp">TV punčochy<span>(Zip Sox &amp; Co.)</span></th>
            <th class="knc-us">NORIKS<em class="knc-badge">Č. 1</em></th>
          </tr>
        </thead>
        <tbody>
          <tr><td>Medicínská komprese</td><td class="ok">✓</td><td class="no">✕</td><td class="us ok">✓</td></tr>
          <tr><td>Zip pro snadné navlékání</td><td class="no">✕</td><td class="ok">✓</td><td class="us ok">✓</td></tr>
          <tr><td>Samostatné navlékání bez pomoci</td><td class="no">✕</td><td class="mid">~</td><td class="us ok">✓</td></tr>
  ...
  <div style="max-width: 1440px;" class="container why-container">
    ...
    <div class="why-col">
      <div class="video-wrapper">
        <?php if ( $kn_img_1 ) : ?>
          <img loading="lazy" decoding="async" style="width:100%; aspect-ratio:1/1; object-fit:cover;" src="<?php echo esc_url( $kn_img_1 ); ?>" alt="Kompresní punčochy">
    ...
    <div class="why-col why-content">
      <h2 style="color: #222; text-align:left; margin-left: 20px; font-family: 'Barlow', sans-serif; color:#222223;">
        PROČ KOMPRESNÍ PUNČOCHY?
      </h2>

      <div style="margin-left: 20px;" class="why-point">
        <p><strong>Lepší cirkulace, méně únavy</strong></p>
        <p class="description">Postupná komprese jemně podporuje průtok krve k srdci, snižuje pocit těžkých a unavených nohou a pomáhá, aby nohy zůstaly lehké i během nejdelšího dne.</p>
      </div>

      <div style="margin-left: 20px;" class="why-point">
        <p><strong>Méně otoků</strong></p>
        <p class="description">Ideální pro dlouhé cesty, dlouhé stání nebo sezení. Rovnoměrný tlak snižuje zadržování tekutin a otoky kotníků a lýtek.</p>
      </div>

      <div style="margin-left: 20px;" class="why-point">
        <p><strong>Opora, kterou ucítíte</strong></p>
        <p class="description">Anatomický střih drží punčochu na místě, bez stahování v horní části. Pocit pevné, ale příjemné opory po celý den.</p>
      </div>
    </div>
...
<section class="why-section knc-ugc">
  <div class="knc-ugc-wrap">
    <h2 class="knc-ugc-title">Co říkají naši zákazníci</h2>
