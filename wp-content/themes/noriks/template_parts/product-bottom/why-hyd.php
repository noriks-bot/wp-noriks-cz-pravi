...
$nhy_marquee = array(
  ...
  array( 'beskraj', 'Trvalý filtr, bez zamjena' ),
...
<!-- ============ 2) Podívejte se, jak perlí ============ -->
<section class="nhy-sec">
  <div class="nhy-wrap">
    <h2 class="nhy-h2 nhy-center">Podívejte se, jak perlí</h2>
    <p class="nhy-fizz-text">Podívejte se na silné bublinky, které vznikají během elektrolýzy — to je čistá infuze vodíku v nejlepší podobě. Voda přitom zůstává čirá a osvěžující po každém cyklu.</p>
    <div class="nhy-fizz">
...
<!-- ============ 3) Síla antioxidantů, méně zánětů ============ -->
<section class="nhy-sec nhy-alt">
  <div class="nhy-wrap nhy-row2">
    <div class="nhy-copy">
      <h2 class="nhy-h2">Síla antioxidantů, méně zánětů</h2>
      <p>Vodíková voda je známá silným antioxidačním a protizánětlivým účinkem, který vědecké výzkumy spojují s přínosy u více než 150 stavů.</p>
      <p>Klinické studie ukázaly také to, že vypití tří lahví vodíkové vody může mít antioxidační účinek srovnatelný s konzumací stovek kusů ovoce a zeleniny.</p>
      <p class="nhy-note">Vodíková voda je doplněk každodenní hydratace, nikoli náhrada lékařské léčby.</p>
    </div>
...
<section class="nhy-sec">
  <div class="nhy-wrap nhy-center">
    <h2 class="nhy-h2">Skutečné příběhy uživatelů</h2>
  </div>
  <div class="nhy-wrap nhy-row2">
    ...
    <div class="nhy-copy">
      <ul class="nhy-stories">
        <li><strong>Regenerace s více energií</strong><span>„Nakon svakog treninga osjećam manje umora u mišićima. HydraH₂ mi je oporavak učinio jednostavnim."</span></li>
        <li><strong>Hydratace, kterou je vidět</strong><span>„Koža mi je punija i bolje hidrirana. Savršeno za svakodnevnu rutinu."</span></li>
...
<!-- ============ 5) Výhody vodíkové vody ============ -->
<section class="nhy-sec nhy-alt">
  <div class="nhy-wrap nhy-center">
    <h2 class="nhy-h2">Výhody vodíkové vody</h2>
  </div>
  <div class="nhy-wrap">
    <div class="nhy-perks">
      <div class="nhy-perk"><strong>Lepší hydratace</strong><span>Obohacuje vodu vodíkem vysoké koncentrace pro optimální hydrataci.</span></div>
      <div class="nhy-perk"><strong>Nabíjecí baterie</strong><span>USB nabíjení za méně než 60 minut udrží láhev připravenou celý den.</span></div>
      <div class="nhy-perk"><strong>Trvalý filtr</strong><span>Zabudovaný filtr není třeba měnit — šetří vám čas i peníze.</span></div>
      <div class="nhy-perk"><strong>Rychlé cykly</strong><span>Vyberte si cyklus 3 nebo 10 minut pro přizpůsobenou dávku vodíku.</span></div>
    </div>
  </div>
</section>

<!-- ============ 6) Pokročilá výroba vodíku ============ -->
<section class="nhy-sec">
  <div class="nhy-wrap nhy-row2">
    <div class="nhy-media"><?php echo $nh_img('hyd-04-kako-radi.webp','PEM i SPE elektroliza — proizvodnja vodika'); ?></div>
    <div class="nhy-copy">
      <h2 class="nhy-h2">Pokročilá výroba vodíku</h2>
      <p>Díky špičkové <strong>PEM a SPE elektrolýze</strong> NORIKS HYD vytváří až <strong>3 000 ppb</strong> molekulárního vodíku ve vodě. Skleněná láhev se základnou z nerezové oceli zajišťuje, že voda nikdy nepřijde do styku s plastem, a trvalý filtr generátoru odstraňuje starosti s údržbou. Automatické odvzdušnění odvede zbytkové plyny pro čisté a bezpečné pití.</p>
      <ul class="nhy-check">
        <li>Titanové elektrody s platinovou vrstvou</li>
        <li>99,99 % čistý vodík, vedlejší produkty odcházejí odvzdušněním</li>
        <li>Funguje s jakoukoli pitnou vodou, i s destilovanou</li>
      </ul>
    </div>
  </div>
</section>
...
<section class="nhy-sec nhy-alt">
  <div class="nhy-wrap nhy-row2">
    <div class="nhy-copy">
      <h2 class="nhy-h2">Připraveni posunout hydrataci na vyšší úroveň?</h2>
      <p>Přidejte se k tisícům těch, kteří svou wellness rutinu vylepšili vodou bohatou na vodík. Pociťte příval energie, lepší regeneraci a hydrataci, kterou je vidět.</p>
      <a class="nhy-cta" href="#bundle-selector">Objednat NORIKS HYD</a>
    </div>
