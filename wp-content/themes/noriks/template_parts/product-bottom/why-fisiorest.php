 ...
 *
 * SCAFFOLD — media v tématu: img/fisiorest*.
 */
if ( ! defined( 'ABSPATH' ) ) { exit; }

// 1) "Vědecky podložené" — 4 karty.
$fis_science = array(
    array( 'title' => 'Hrb na krku',         'text' => 'Trakce <strong>uvolní tlak a obnoví správné držení těla</strong>, aby zmírnila hrb způsobený „technologickým krkem".' ),
    array( 'title' => 'Bolesti krku',        'text' => '<strong>Zmírní svalové uzly a ztuhlost</strong> a <strong>znovu srovná zakřivení krku</strong> pro rychlou úlevu od bolesti.' ),
    array( 'title' => 'Kvalitní spánek',     'text' => 'Uklidňující terapie <strong>uvolní krk a páteř</strong> pro hluboký a osvěžující spánek.' ),
    array( 'title' => 'Uvolnění stresu',     'text' => 'Teplá masáž a protažení <strong>uvolní nahromaděné napětí</strong> pro větší pohodlí.' ),
);
...
$fis_experts = array(
    array( 'img' => $fis_i.'fis-strucnjak-1.jpg', 'name' => 'Marina Nováková', 'role' => 'Certifikovaná masérka', 'org' => '' ),
    array( 'img' => $fis_i.'fis-strucnjak-2.jpg', 'name' => 'Anna Kovářová', 'role' => 'Fyzioterapeutka', 'org' => '' ),
    array( 'img' => $fis_i.'fis-strucnjak-3.jpg', 'name' => 'Ivana Novotná', 'role' => 'Chiropraktička', 'org' => '' ),
);
// 4) Zkušenosti uživatelů
$fis_ugc = array(
    array( 'vid' => $fis_v.'v09c.mp4', 'cap' => '„Poprvé po dlouhé době jsem konečně bez bolesti…"' ),
    array( 'vid' => $fis_v.'v06.mp4', 'cap' => '„Polštář NORIKS je moje nová každodenní nezbytnost…"' ),
    array( 'vid' => $fis_v.'v11c.mp4', 'cap' => '„Velmi mi pomáhá při uvolňování napětí v krku a ramenou."' ),
    array( 'vid' => $fis_v.'v02c.mp4', 'cap' => '„Pokud jste se právě stala maminkou, tohle by mohlo být přesně to, co potřebujete…"' ),
);
// 5) ThermoTrac 3v1
$fis_thermo = array(
    array( 'vid' => $fis_v.'v10.mp4', 'title' => 'Terapie trakcí' ),
    array( 'vid' => $fis_v.'v07.mp4', 'title' => 'Terapie vibracemi' ),
    array( 'vid' => $fis_v.'v05.mp4', 'title' => 'Terapie teplem' ),
);
// 6) Čtyři vylepšení
$fis_upgrades = array(
    array( 't' => 'Dobíjecí baterie',          'd' => 'Vezměte si ho kamkoli — baterie 2500 mAh vydrží až 2 hodiny.' , 'ico' => 'battery-v2.png' ),
    array( 't' => 'Potah z morušového hedvábí', 'd' => 'Obalený chladivým hedvábím pro měkký, luxusní pocit.' , 'ico' => 'silk-v2.png' ),
    array( 't' => 'Vypnutí po 30 min',         'd' => 'Čtyři 30minutové relace na jedno nabití, bez starostí.' , 'ico' => 'timer-v2.png' ),
    array( 't' => 'Regulované teplo',          'd' => 'Zahřívání na 50 °C pomocí pokročilé technologie ThermoTrac.' , 'ico' => 'heat-v2.png' ),
);
?>
...
<section class="fis-science">
  <div class="fis-wrap">
    <div class="fis-box">
      <h2 class="fis-title">Vědecky podložené: prokázaná úleva pro péči o krk</h2>
      <div class="fis-grid">
...
<section class="fis-hero">
  ...
  <div class="fis-hero-inner">
    <h2 class="fis-hero-title">Odemkněte hluboký restart díky spojené síle srovnání a uvolnění</h2>
  </div>
</section>
...
<section class="fis-experts">
  <div class="fis-wrap fis-exp-grid">
    <div class="fis-exp-quote">
      <h2 class="fis-h2">Doporučují odborníci</h2>
      <p>„NORIKS je jeden z nejlepších polštářů na krk, které jsou momentálně na trhu. Protože se ve wellness komunitě pohybuji už více než 25 let, vyzkoušela jsem různé polštáře na krk, a to, čím NORIKS vyniká, je funkce trakce…</p>
      <p>Pokud máte předsunutou hlavu nebo „nahrbené držení těla", trakce může pomoci znovu srovnat obratle a plně podepřít tělo. Sama ho používám a doporučuji svým klientům!"</p>
      <p class="fis-exp-author"><strong>Marina Nováková</strong><br>Certifikovaná masérka</p>
    </div>
...
<section class="fis-thermo">
  <div class="fis-wrap">
    <p class="fis-eyebrow"><strong>ThermoTrac™</strong> technologie</p>
    <h2 class="fis-h2 fis-center">Zažijte 3v1 terapii pro krk</h2>
...
<section class="fis-upg">
  <div class="fis-wrap">
    <h2 class="fis-h2 fis-center">Čtyři velká vylepšení</h2>
...
<section class="fis-cheaper">
  <div class="fis-wrap fis-row2">
    ...
    <div class="fis-row2-copy">
      <p class="fis-eyebrow">BEZPEČNÁ A UVOLŇUJÍCÍ TERAPIE</p>
      <h2 class="fis-h2">14× levnější než týdenní návštěvy</h2>
      <p>NORIKS se vám vrátí ve dnech, ne v měsících. Doporučovaný terapeuty, nabízí jemnou úlevu bez hrubého tlaku či rizikových zákroků. Používejte ho každý večer. Bez objednávání. Bez cestování. Bez opakovaných nákladů — jen bezpečná, konzistentní péče o krk, kdykoli ji potřebujete.</p>
    </div>
  </div>
</section>
...
<style>
  ...
  /* 1) Vědecky podložené — šedá karta */
  ...
  /* Žádný odkaz "Tabulka velikostí" na FisioRestu (stejně jako bunion). */
  .noriks-global-sizechart, .gck-size-link, .gck-size-link-wrap,
  #open-size-chart, #open-size-chartCustom { display: none !important; }

  /* Krátký popis: skryj standardní odrážky (•), rozestupy. */
...
<script>
/* Oranžová aktivní bundle-option přes inline !important (přežije LiteSpeed UCSS). */
(function(){
  function paintOrto(){
