<?php
/**
 * Tablica velicina za NORIKS FIT Woman (orto-kompwom) — trg CZ.
...
<div id="custom-size-chart-modal" class="kwsc" role="dialog" aria-modal="true" aria-labelledby="kwsc-title">
  <div class="kwsc-box">
  <div class="kwsc-bar">
    <h2 id="kwsc-title">Tabulka velikostí</h2>
    <span id="close-size-chart-x" role="button" tabindex="0" aria-label="Zavřít">&times;</span>
  </div>

  <div class="kwsc-body">
    <p class="kwsc-lead">Velikost vybírejte podle <strong>obvodu hrudníku</strong> — ten určuje, jak tričko sedne na prsa a ramena. Jste-li mezi dvěma velikostmi, vezměte <strong>větší</strong>.</p>


    <div class="kwsc-scroll">
      <table class="kwsc-table">
        <thead>
          <tr><th scope="col">Velikost</th><th scope="col">Obvod hrudníku</th><th scope="col">Obvod pasu</th></tr>
        </thead>
        <tbody>
    ...
    <div class="kwsc-how">
      <h3>Jak měřit</h3>
      <ol>
        <li><strong>Hrudník</strong> — přes nejširší část hrudníku, páska vodorovně okolo těla.</li>
        <li><strong>Pas</strong> — nejužší část pasu, obvykle kousek nad pupkem.</li>
        <li><strong>Vyberte řádek</strong>, ve kterém jsou obě čísla; pokud padnou do dvou řádků, vezměte větší velikost.</li>
      </ol>
      <p class="kwsc-note">Měřte přes spodní prádlo, ne přes oblečení. Páska ať přiléhá, ale nestahuje.</p>
    </div>
  </div>
  </div>
</div>
