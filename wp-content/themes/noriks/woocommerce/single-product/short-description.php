...
<div class="nhs-usp">
  <div class="nhs-usp-guarantee"><svg width="15" height="15" viewBox="0 0 24 24" style="flex:0 0 auto;"><circle cx="12" cy="12" r="12" fill="#7c3aed"/><path d="M7 12.5l3 3 7-7" fill="none" stroke="#fff" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/></svg> 30denní záruka vrácení peněz</div>
  <div class="nhs-usp-grid">
    <div><span class="nhs-usp-ic">≈</span> Vyhlazuje vrásky</div>
    <div><span class="nhs-usp-ic">↓</span> Redukuje jemné linie</div>
    <div><span class="nhs-usp-ic">♡</span> Zjemňuje jizvy přes noc</div>
    <div><span class="nhs-usp-ic">✚</span> Extra lepivé</div>
    <div><span class="nhs-usp-ic">✓</span> Opakovaně použitelné a odolné</div>
    <div><span class="nhs-usp-ic">↗</span> Podporuje tvorbu kolagenu</div>
  </div>
</div>
<style>
...
<div class="kn2-badge">
  ...
  <span>Doporučení pediatrů</span>
</div>
<div class="kn2-below">
  <div class="kn2-trust">
    <span><svg width="16" height="16" viewBox="0 0 24 24"><path d="M12 2l8 3v6c0 5-3.5 9.5-8 11-4.5-1.5-8-6-8-11V5l8-3z" fill="#2b3fb0"/><path d="M8.5 12l2.5 2.5 4.5-4.5" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg> 90 nocí na vyzkoušení</span>
    <span><svg width="18" height="14" viewBox="0 0 24 18"><rect x="1" y="3" width="13" height="10" rx="1.5" fill="#2b3fb0"/><path d="M14 6h4l4 4v3h-8z" fill="#2b3fb0"/><circle cx="6" cy="15" r="2.4" fill="#1b2450"/><circle cx="18" cy="15" r="2.4" fill="#1b2450"/></svg> Rychlé doručení</span>
    <span><svg width="17" height="15" viewBox="0 0 24 20"><rect x="3" y="2" width="18" height="11" rx="2" fill="none" stroke="#2b3fb0" stroke-width="2"/><circle cx="12" cy="7.5" r="2.6" fill="#2b3fb0"/><path d="M2 17c3 2 7 3 10 3s7-1 10-3" fill="none" stroke="#2b3fb0" stroke-width="2" stroke-linecap="round"/></svg> Platba i na dobírku</span>
  </div>
  <div class="kn2-redbox">
    <p class="kn2-red-title"><svg width="14" height="13" viewBox="0 0 24 22" style="vertical-align:-2px;margin-right:6px;"><path d="M12 1L23 21H1L12 1z" fill="none" stroke="#c0452f" stroke-width="2.4" stroke-linejoin="round"/><path d="M12 8v6" stroke="#c0452f" stroke-width="2.4" stroke-linecap="round"/><circle cx="12" cy="17.4" r="1.3" fill="#c0452f"/></svg>PRO RODIČE DĚTÍ MLADŠÍCH 9 LET</p>
    <p class="kn2-red-body">Každou noc na nesprávném polštáři <strong class="kn2-red">se obličej vašeho dítěte formuje — špatným směrem.</strong> Slintání. Chrápání. Otevřená ústa. Do <strong class="kn2-red">9 let</strong> se změny upevní. Do <strong class="kn2-red">14</strong> — drahá rovnátka. Do <strong class="kn2-red">18</strong> — rozhovor o vážnějších zákrocích. Dětští stomatologové specializovaní na dýchací cesty to vídají denně — přestali tomu říkat vzácnost. <strong class="kn2-red">Vyměňte polštář ještě dnes večer.</strong></p>
  </div>
</div>
<style>
  /* Badge iznad naslova */
...
(function(){
  function init(){
    ...
    /* Ribboni: strip ogenj + dodaj "Nejlepší hodnota" na 3. karto */
    document.querySelectorAll('.gck-popular-badge, .gck-popular-badge-2').forEach(function(b){ b.textContent=b.textContent.replace('🔥','').trim(); if(/Nejoblíbenější/i.test(b.textContent)) b.textContent='Nejoblíbenější'; });
    ...
    if(cards.length>=3 && !cards[2].querySelector('.kn2-ribbon') && !cards[2].querySelector('.gck-popular-badge, .gck-popular-badge-2')){
      var rb=document.createElement('div'); rb.className='kn2-ribbon'; rb.textContent='Nejlepší hodnota'; cards[2].appendChild(rb);
    }
...
<div class="oj-recpill">
  <img src="<?php echo esc_url( get_template_directory_uri().'/img/ortopedski-jastuk/04_lijecnik_HR.png' ); ?>" alt="Lékař" class="oj-recpill-av" onerror="this.style.display='none'">
  <span><strong>Doporučuje dr. Marić</strong>&nbsp;|&nbsp;<em>Specialista na páteř</em></span>
...
<div class="oj-stockpill">
  ...
  <em>Zbývá už jen několik kusů!</em>
</div>
...
<div class="oj-orders">
  ...
  <em><strong>128 objednávek</strong> za posledních <strong>24 hodin!</strong></em>
</div>
<style>
...
<div class="ncl-trust">
  <span>Pro křišťálově čisté sklo a sprchové kouty,</span>
  <span class="ncl-trust-stars">★★★★★</span>
  <span>důvěřuje nám 138 452+ domácností</span>
</div>
<style>
