 ...
 <div class="accordion">
    ...
    <div class="accordion-item">
      ...
      <div class="accordion-content">
        ...
        <p>KidsNest ve velikosti <strong>9–18 let</strong> je vyroben pro starší hlavu, krk a ramena. Jiná kontura, jiná výška, jiná opora. Stejný základní mechanismus: správné zarovnání hlavy, krku a čelisti, celou noc, na těle, které ještě roste.</p>
...
<br>
     ...
     <?php if ( ! ( function_exists('noriks_is_type') && ( noriks_is_type('bunion', $current_product_id) || noriks_is_type('fisiorest', $current_product_id) || noriks_is_type('norikshers', $current_product_id) || noriks_is_type('ortopedski-jastuk', $current_product_id) ) ) ) : // žádná tabulka velikostí pro bunion + fisiorest + norikshers + ortopedicky polstar ?>
     <div class="accordion-item">
      <div class="accordion-header" onclick="toggleAccordion(this)">
      ...
      <div class="accordion-content">
        ...
        elseif ( function_exists('noriks_is_type') && noriks_is_type('kompresijske-nogavice', $current_product_id) ): ?>
                  ...
                  <img class="js-open-size-chart" style="cursor:pointer;" src="<?php echo get_template_directory_uri(); ?>/img/kompresijske-tabela-cz.webp" alt="Tabulka velikostí — kompresní ponožky">
