...
<div class="nmn">
  <div class="nmn-wrap">
    ...
    <p class="nmn-sub">Stáhněte si návod pro svůj produkt NORIKS ve formátu PDF.</p>
    ...
    <div class="nmn-search">
      ...
      <input type="search" id="nmn-q" placeholder="Hledat podle názvu produktu…" autocomplete="off">
    </div>
          ...
          <div class="nmn-body">
            ...
            <p class="nmn-links">
              <a class="nmn-btn" href="<?php echo esc_url( $dir_url . $m['file'] ); ?>" target="_blank" rel="noopener">
                Stáhnout PDF <span>(<?php echo esc_html( $size ); ?>)</span>
              </a>
              <?php if ( $p['url'] ) : ?>
    ...
    <p class="nmn-empty" id="nmn-empty" hidden>Pro tento výraz nejsou žádné návody. Napište nám na <a href="mailto:info@noriks.com">info@noriks.com</a>.</p>
    <p class="nmn-help">Potřebujete pomoc s produktem? Napište nám na <a href="mailto:info@noriks.com">info@noriks.com</a>.</p>
  </div>
</div>
