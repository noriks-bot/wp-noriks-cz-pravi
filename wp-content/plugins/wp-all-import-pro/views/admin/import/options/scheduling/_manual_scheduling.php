<div>
    <label class="manual-scheduling-label">
        ...
        <h4 style="margin: 0;display: inline-block;"><?php _e('Manual Scheduling', PMXI_Plugin::LANGUAGE_DOMAIN); ?></h4>
    </label>
    <div class="run-this-export-using-cronjobs" style="margin-left: 26px; margin-bottom: 10px; font-size: 13px; margin-top:12px;"><?php _e('Run this import using cron jobs.'); ?></div>
