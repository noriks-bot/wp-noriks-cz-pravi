					...
					<table class="form-table" style="max-width:none;">
						<tr>
							<td>
								...
								<?php include( '_reimport_comments_options.php' ); ?>
									...
									<div style="margin-left: -4px;">
										<div class="input">
											<div class="input">
												...
												<label for="duplicate_indicator_custom_field"><?php _e('Custom field', 'wp_all_import_plugin' )?></label>
											</div>
											<div class="switcher-target-duplicate_indicator_custom_field" style="padding-left:17px;">
											...
											<div class="input">
												...
												<label for="duplicate_indicator_pid"><?php _e('Comment ID', 'wp_all_import_plugin' )?></label>
											</div>
